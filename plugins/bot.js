...
module.exports = {
  ...
  "jang bal falaba🙂","iss ato dako keno lojja lage to 🫦🙈",
      ];
      ...
      const greetingMessage = await api.sendMessage(threadId, {
        text: `HUSSAIN X PROJECT @${userToMention.split('@')[0]}, ${randomGreeting}`,
